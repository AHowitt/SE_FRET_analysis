c%% DISPLAY - POPULATION from single cells
...
fig_leg1 = 'Untreated';
fig_leg2 = 'Cell-Tak (med)';
fig_leg3 = 'Cell-Tak (high)';
...
hf = figure;
    ...
    title('FRET index')
    legend(fig_leg1, fig_leg2, fig_leg3, 'Location', 'southeast')
...
%     Normalised to t0
    ...
    hf = figure;
    plot(time(1:end),A_frt_n(1:end),'b','LineWidth',3)c
    hold on
